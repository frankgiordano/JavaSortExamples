...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ptasks.sort(Comparator.comparing(PriorityTask::isMustGo).reversed().thenComparing(PriorityTask::getDeadLineDate)
                .thenComparing(PriorityTask::getStartDateTime));
